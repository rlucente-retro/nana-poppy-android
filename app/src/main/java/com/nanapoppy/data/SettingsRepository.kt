...
class SettingsRepository(context: Context) {
    ...
    var location1Query: String
        get() = prefs.getString("location1_query", null) ?: com.nanapoppy.BuildConfig.LOCATION1_QUERY.ifBlank { "Waynesboro,PA" }
        set(value) = prefs.edit().putString("location1_query", value).apply()

    var location2Query: String
        get() = prefs.getString("location2_query", null) ?: com.nanapoppy.BuildConfig.LOCATION2_QUERY.ifBlank { "Ocean City,MD" }
